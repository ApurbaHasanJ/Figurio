  ...
  return (
    <div className="my-container mt-12">
      ...
      <p className="text-gray-600 mb-4 text-center">
        Explore our collection of action figures from popular franchises. We
        feature a variety of characters from Marvel, Star Wars, Transformers,
        and more. Each action figure is meticulously crafted to capture the
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-5">
        {characters.map((character) => (
          <div
            key={character.name}
            className="bg-white p-4 drop-shadow-xl rounded-lg"
          >
            ...
            <div className="mb-3">
              ...
              <p className="text-gray-500 badge mt-2">
